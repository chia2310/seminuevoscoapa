   ...
   <div class="position_content" id="page_position_content">
    ...
    <div class="botonrojo clearfix colelem" id="u1275"><!-- group -->
     <div class="clearfix grpelem" id="u1289-4"><!-- content -->
      <p><span class="lucida-14-whit-bold">aqui va el nombre del auto</span></p>
     </div>
    </div>
    <div class="clearfix colelem" id="pslideshowu1126"><!-- group -->
      ...
      <div class="popup_anchor" id="u1168popup">
       <div class="SlideShowContentPanel clearfix" id="u1168"><!-- stack box -->
        <div class="SSSlide shadow clearfix grpelem" id="u1414"><!-- image -->
         <div id="u1414_clip">
          <img class="ImageInclude position_content" id="u1414_img" data-src="images/dsc_1161-2.jpg" src="images/blank.gif" alt="" data-width="480" data-height="383"/>
         </div>
        </div>
     ...
     <div class="clearfix grpelem" id="pu1329-4"><!-- column -->
      <div class="clearfix colelem" id="u1329-4"><!-- content -->
       <p><span class="lucida-rojo">$Aqui va precio</span></p>
      </div>
      <div class="clearfix colelem" id="u1332-4"><!-- content -->
       <p><span class="lucida-rojo">aqui pondra año</span></p>
      </div>
      <div class="clearfix colelem" id="u1333-4"><!-- content -->
       <p><span class="lucida-rojo">aqui kilometraje</span></p>
      </div>
      <div class="clearfix colelem" id="u1334-4"><!-- content -->
       <p><span class="lucida-rojo">aqui combustible</span></p>
      </div>
      <div class="clearfix colelem" id="u1335-4"><!-- content -->
       <p><span class="lucida-rojo">aqui transmision</span></p>
      </div>
      <div class="clearfix colelem" id="u1336-4"><!-- content -->
       <p><span class="lucida-rojo">aqui va marca</span></p>
      </div>
      <div class="clearfix colelem" id="u1337-4"><!-- content -->
       <p><span class="lucida-rojo">aqui va modelo</span></p>
      </div>
      <div class="clearfix colelem" id="u1338-4"><!-- content -->
       <p><span class="lucida-rojo">aqui va version</span></p>
      </div>
     </div>
    </div>
    ...
    <div class="shadow rounded-corners clearfix colelem" id="u1546"><!-- group -->
     <div class="clearfix grpelem" id="u1547-10"><!-- content -->
      <p><span class="lucida-gris" id="u1547">descripcion</span></p>
      <p><span class="lucida-gris" id="u1547-3">se</span></p>
      <p><span class="lucida-gris" id="u1547-5">pone</span></p>
      <p><span class="lucida-gris" id="u1547-7">en este lugar</span></p>
     </div>
    </div>
...
Muse.Utils.initWidget('#slideshowu1126', function(elem) { new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true}); });/* #slideshowu1126 */
Muse.Utils.initWidget('#slideshowu3758', function(elem) { new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:true,shuffle:false,transitionDuration:500,enableSwipe:true}); });/* #slideshowu3758 */
