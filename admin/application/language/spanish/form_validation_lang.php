...
$lang['regex_match']		= "El campo %s no tiene el formato adecuado.";
$lang['matches']			= "El campo %s no coincide con el campo %s.";
$lang['is_unique'] 			= "El campo %s debe contener un valro único.";
...
$lang['valida_fechas_esp']		= "El campo %s no contiene un formato válido de fecha.";
$lang['valida_moneda']		= "El campo %s no contiene un formato válido de moneda.";
